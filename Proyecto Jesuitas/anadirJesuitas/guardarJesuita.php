...
//Cadena de caracteres de la consulta sql	
	$sql = "INSERT INTO jesuita (nombre, codigo, nombreAlumno, firma, firmaIngles) VALUES ('$nombre', '$codigo', '$nombreAlumno', '$firma', '$firmaIngles');";   //completa lo que falta
	...
	if ($conexion->affected_rows > 0) {
		...
		echo '<h3><a href="anadirJesuita.html">Añadir otro Jesuita</a></h3>';
	} else {
		echo "<h2>Error. Jesuita no añadido</h2>";
		echo '<h3><a href="anadirJesuita.html">Vuelve a intentarlo</a></h3>';
	}
